    ...
    <>
      <div className="container lh:mb-[100px] mb-16" id="contact">
        <div className="bg-contact-form lg:px-32 px-8 pt-16 text-white rounded-lg pb-32">
            <h2 className="lg:text-[70px] lg:leading-[80px] text-[38px] leading-[45px] font-bold uppercase">{title1 ? title1 : "Let's Start Your " }<span className="lg:text-[80px] leading-[62px] lg:leading-[80px] text-[65px] block">{title2 ? title2 : "Project Today" }</span></h2>
