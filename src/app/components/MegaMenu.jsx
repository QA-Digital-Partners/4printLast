            ...
            <div className="lg:w-6/12 flex flex-wrap px-2 content-start">
              ...
              <div className="lg:w-6/12">
                ...
                <ul className="list-menu text-[18px]">
                  <li className="py-1"><a href="/car-wraps-maryland/commercial/fleet">Fleet</a></li>
                  <li className="py-1"><a href="/car-wraps-maryland/commercial/food-trucks">Food Trucks</a></li>
                </ul>
              </div>
              <div className="lg:w-6/12">
                <a href="/custom-car-wraps" className="font-bold text-[20px] pb-2">Custom Wrap</a>
                <ul className="list-menu lg:ms-6">
                  <li className="py-1"><a href="/custom-car-wraps#graphicDesign">Graphic Design</a></li>
                  <li className="py-1"><a href="/custom-car-wraps#coloChange">Color Change</a></li>
                  <li><a href="/custom-car-wraps#textured">Textured</a></li>
                </ul>
              </div>
            </div>
            <div className="lg:w-6/12 flex flex-wrap px-2 content-start">
              <a href="/commercial-printing" className="w-full text-center font-bold text-4pblue text-[23px]">Commercial Printing</a>
                ...
                <div className="lg:w-6/12">
                  <ul className="list-menu ">
                    <li className="py-1"><a href="/commercial-printing#wallwrap">Wall Wrap</a></li>
                    <li className="py-1"><a href="/commercial-printing#windowvinyls">Windows Vynils</a></li>
                    <li className="py-1"><a href="/commercial-printing#banners">Banners</a></li>
                    <li className="py-1"><a href="/commercial-printing#stickers">Stickers</a></li>
                  </ul>
                </div>
                <div className="lg:w-6/12">
                <ul className="list-menu">
                    <li className="py-1"><a href="/commercial-printing#carmagnets">Car Magnets</a></li>
                    <li className="py-1"><a href="/commercial-printing#postcards">Stationary</a></li>
                    <li className="py-1"><a href="/commercial-printing#yardsigns">Yard Signs</a></li>
                    <li className="py-1"><a href="/commercial-printing#minimenu">And More</a></li>
                  </ul>
                </div>
            </div>
          </div>
